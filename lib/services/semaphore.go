...
func AcquireSemaphoreLock(ctx context.Context, cfg SemaphoreLockConfig) (*SemaphoreLock, error) {
	...
	lock := &SemaphoreLock{
		...
		lease0:   *lease,
		retry:    retry,
		ticker:   time.NewTicker(cfg.Expiry / 2),
...
// CheckAndSetDefaults checks and sets default parameters
func (s *AcquireSemaphoreRequest) CheckAndSetDefaults() error {
	if s.SemaphoreKind == "" {
...
func (s *AcquireSemaphoreRequest) lease() *SemaphoreLease {
...
func (s *AcquireSemaphoreRequest) leaseRef() SemaphoreLeaseRef {
...
type Semaphore interface {
	...
	Acquire(params AcquireSemaphoreRequest) (*SemaphoreLease, error)
...
// Acquire attempts to acquire a lease with this semaphore.
func (c *SemaphoreV3) Acquire(params AcquireSemaphoreRequest) (*SemaphoreLease, error) {
